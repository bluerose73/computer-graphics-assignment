...
// Copied from https://learnopengl.com/code_viewer_gh.php?code=src/5.advanced_lighting/4.normal_mapping/normal_mapping.cpp
...
Box::Box(glm::vec3 position, float scale): MovableObject(position), scale_(scale) {
...
void Box::Draw(const glm::mat4 &view_projection, const glm::vec3 camera_pos,
